...
:::{.fragment}
Assign the function output of `read_tsv()` <br>to the object <br>`sulis_bar_data`.
:::
...
3. Looking for inspiration of what's possible? — Scroll through #TidyTuesday on social media
